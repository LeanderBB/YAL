...
namespace yal {
    ...
    ExprTypeFnCallStatic::ExprTypeFnCallStatic(Module& module,
        ...
        ExprFnCall(module, AstType::ExprTypeFnCallStatic,
    ...
    void
    ExprTypeFnCallStatic::setFunctionType(const TypeDecl *functionType){
    ...
    void
    ExprTypeFnCallStatic::acceptVisitor(AstVisitor& visitor) {
        visitor.visit(*this);
    }
