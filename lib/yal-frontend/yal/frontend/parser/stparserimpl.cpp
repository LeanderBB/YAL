...
{
    yylhsminor.yy167 = pParser->createNode<yal::frontend::STDeclVar>(yymsp[-3].minor.yy57, yymsp[-2].minor.yy71, yymsp[0].minor.yy162, false);
...
#line 1755 "stparserimpl.c"
  yymsp[-4].minor.yy167 = yylhsminor.yy167;
        break;
      case 54: /* decl_var ::= LET identifier var_type_spec ASSIGN expression */
#line 373 "stparserimpl.lemon"
{
    yylhsminor.yy167 = pParser->createNode<yal::frontend::STDeclVar>(yymsp[-3].minor.yy57, yymsp[-2].minor.yy71, yymsp[0].minor.yy162, true);
    auto srcInfo = yal::frontend::CreateSourceInfo(yymsp[-4].minor.yy0, yymsp[0].minor.yy162->getSourceInfo(), pParser->getSourceHandle());
    yylhsminor.yy167->setSourceInfo(srcInfo);
}
