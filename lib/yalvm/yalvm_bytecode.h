...
enum yalvm_bytecode_inst
{
    ...
    /* Print instruction */
    YALVM_BYTECODE_PRINT_I,
    YALVM_BYTECODE_PRINT_IL,
    YALVM_BYTECODE_PRINT_U,
    YALVM_BYTECODE_PRINT_UL,
    YALVM_BYTECODE_PRINT_F,
    YALVM_BYTECODE_PRINT_FL,
    YALVM_BYTECODE_PRINT_STR_CONSTANT,
    YALVM_BYTECODE_PRINT_STR_OBJECT,
    YALVM_BYTECODE_PRINT_NL,
    /* Objects */
    YALVM_BYTECODE_OBJECT_ALLOC,
    YALVM_BYTECODE_OBJECT_ACQUIRE,
    YALVM_BYTECODE_OBJECT_RELEASE,
    YALVM_BYTECODE_OBJECT_DEALLOC,
    /* Strings Objects */
    ...
    /* Arrray manip */
    YALVM_BYTECODE_ARRAY_ALLOC_32,
    YALVM_BYTECODE_ARRAY_ALLOC_64,
    YALVM_BYTECODE_ARRAY_ALLOC_OBJ,
    YALVM_BYTECODE_ARRAY_PUT_32,
    YALVM_BYTECODE_ARRAY_PUT_64,
    YALVM_BYTECODE_ARRAY_PUT_OBJ,
    YALVM_BYTECODE_ARRAY_GET_32,
    YALVM_BYTECODE_ARRAY_GET_64,
    YALVM_BYTECODE_ARRAY_GET_OBJ,
    YALVM_BYTECODE_ARRAY_DEL_32,
    YALVM_BYTECODE_ARRAY_DEL_64,
