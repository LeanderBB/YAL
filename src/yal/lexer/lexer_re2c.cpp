/* Generated by re2c 1.0.2 on Tue Oct 31 08:58:22 2017 */
/*
...
namespace yal {
    ...
    Lexer::setToken(const Token token,
        ...
        const void* streamPtr = m_stream.getPtrAt(m_curToken.tokenOffsetInStream);
        m_curToken.tokenStr = StringRef(reinterpret_cast<const char*>(streamPtr),
                                        m_curToken.tokLen);
    }
